...
import { LuncIneratorClient } from './contract/clients/LuncIneratorClient'
...
const App = () => {
  ...
  const contractClient = useMemo(() => {
    ...
    return new LuncIneratorClient(lcd, connectedWallet, contractAddress('lunc-inerator', connectedWallet));
  }, [lcd, connectedWallet]);
